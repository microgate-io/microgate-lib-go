...
func (c *logServiceClient) Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedLogServiceServer) Log(context.Context, *LogRequest) (*empty.Empty, error) {
